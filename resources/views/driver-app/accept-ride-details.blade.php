...
@section('content')
    ...
    <header id="header" class="main-header inner-page-header">
        <div class="custom-container">
            <div class="header-panel">
                ...
                <h3 class="fw-medium title-color">Accept Ride Details</h3>
    ...
    <!-- accept ride details section starts -->
            ...
            <div class="bill-details">
                ...
                <div class="total-detail mt-2">
                    ...
                    <div class="grand-total">
                        <h5 class="fw-medium title-color">Total Bill</h5>
                        <h5 class="fw-medium amount success-color">$39</h5>
                    </div>
                </div>
            </div>
    ...
    <!-- accept ride details section end -->
