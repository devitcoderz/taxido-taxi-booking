...
<body>
    ...
    <section class="section-b-space">
                    ...
                    <div class="payment-detail">
                        <div class="form-check flex-spacing w-100 ps-0">
                            <label class="form-check-label w-100 fw-normal title-color flex-align-center gap-2"
                                for="payment1">
                                <img class="img-fluid payment-img" src="../../assets/images/svg/paypal.svg"
                ...
                <li class="payment-box">
                    <div class="payment-detail">
                        <div class="form-check flex-spacing w-100 ps-0">
                            <label class="form-check-label w-100 fw-normal title-color flex-align-center gap-2"
                                for="payment2">
                                <img class="img-fluid  payment-img" src="../../assets/images/svg/apple-pay.svg"
                ...
                <li class="payment-box">
                    <div class="payment-detail">
                        <div class="form-check flex-spacing w-100 ps-0">
                            <label class="form-check-label w-100 fw-normal title-color flex-align-center gap-2"
                                for="payment3">
                                <img class="img-fluid payment-img" src="../../assets/images/svg/google-pay.svg"
        ...
        <div class="fixed-btn">
            <div class="custom-container">
                <a href="wallet.blade.php" class="btn theme-btn w-100 mt-0 auth-btn">Add Balance</a>
            </div>
        </div>
    </section>
    <!-- top up section end -->
