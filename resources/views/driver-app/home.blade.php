        ...
        <div class="custom-container">
            <div class="header-panel">
                <div class="flex-align-center gap-2">
                    ...
                    <img class="img-fluid logo" src="../../assets/images/logo/driver/driver-logo-white.png" alt="logo">
                </div>
    ...
    <section>
        <div class="custom-container">
            <ul class="total-ride-list mt-0 p-0">
                <li>
                    <a href="wallet.blade.php" class="ride-box">
                ...
                <li>
                    <a href="my-rides.blade.php" class="ride-box">
                        <div class="flex-spacing gap-1">
                            <h4>16</h4>
                            <div class="ride-icon">
            ...
            <ul class="my-ride-list driver-ride-list mt-0">
                ...
                <li>
                    <div class="my-ride-box">
                        <div class="my-ride-head">
                            <a href="accept-ride.blade.php" class="my-ride-img">
                                <img class="img-fluid profile-img" src="../../assets/images/profile/p6.png" alt="p5">
                            </a>
            ...
            <ul class="offer-listing">
                <li class="w-100">
                    <div class="offer-box">
                        <div class="offer-head">
                            <a href="accept-ride.blade.php" class="profile-part">
                                <img class=" img-fluid profile-pic" src="../../assets/images/profile/p5.png" alt="p5">
                ...
                <li class="w-100">
                    <div class="offer-box">
                        <div class="offer-head">
                            <a href="accept-ride.blade.php" class=" profile-part">
                                <img class=" img-fluid profile-pic" src="../../assets/images/profile/p6.png" alt="p6">
                                <h6 class="fw-medium">Johnson Smith</h6>
                            </a>
                        </div>
                ...
                <li class="w-100">
                    <div class="offer-box">
                        <div class="offer-head">
                            <a href="accept-ride.blade.php" class=" profile-part">
                                <img class=" img-fluid profile-pic" src="../../assets/images/profile/p4.png" alt="p4">
                                <h6 class="fw-medium">Johnson Smith</h6>
                            </a>
                        </div>
