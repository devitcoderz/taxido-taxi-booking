...
//        $userriderequest->travel_company      = $request->travel_company;
        ...
        $userriderequest->means_of_transport = json_encode($request->input('means_of_transport',[]));
...
//        $userriderequest->travel_company      = $request->travel_company;
        $userriderequest->comments            = $request->comments;
        $userriderequest->message            = 'we are looking for rider to accept the offer';
...
//        dd($userriderequest);
        ...
        $userriderequest->expiry              = Carbon::now()->addMinutes(10);
        $userriderequest->save();
        return view('user-app.targetted-driver-fare-request', ['userriderequest_id' => $userriderequest->id]);
    }
